...
{
    [Property, Group( "HP Balancing" )] public float BaseHP { get; set; } = 20f;
    [Property, Group( "HP Balancing" )] public float HPMult { get; set; } = 60f;

    [Property, Group( "Economy Balancing" )] public float BaseValue { get; set; } = 10f;
    [Property, Group( "Economy Balancing" )] public float ValueMult { get; set; } = 14f;
